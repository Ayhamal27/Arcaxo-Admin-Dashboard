            ...
            {sensor.installed_at && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[15px] font-medium text-[#191919]">
                    {format(new Date(sensor.installed_at), 'd MMM yyyy', { locale: es })}
                  </p>
                </div>
              </div>
            )}
            ...
            {sensor.uninstalled_at && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[15px] font-medium text-[#191919]">
                    {format(new Date(sensor.uninstalled_at), 'd MMM yyyy', { locale: es })}
                  </p>
                </div>
              </div>
            )}
        ...
        <div className="bg-white rounded-[15px] border border-[#E5E5EA] p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-[14px] text-[#191919]">
              {format(new Date(sensor.created_at), 'd MMM yyyy', { locale: es })}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[14px] text-[#191919]">
              {format(new Date(sensor.updated_at), 'd MMM yyyy, HH:mm', { locale: es })}
            </p>
          </div>
          ...
          {sensor.decommissioned_at && (
            <div className="p-3 bg-[#FFE8EC] border border-[#FF4163] rounded-[8px]">
              ...
              <p className="text-[12px] text-[#FF4163]">
                {format(new Date(sensor.decommissioned_at), 'd MMM yyyy', { locale: es })}
              </p>
